...
TEST(RobustSolver, multiRobotPcm)
{
  ...
  lc_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(b2, a2,
      gtsam::Pose3(gtsam::Rot3::Rz(0.1), gtsam::Point3(0, 0.9,0)), noise));

  gtsam::Key a5 = gtsam::Symbol('a',5);
  gtsam::Key b5 = gtsam::Symbol('b',5);
  lc_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(b5, a5,
      gtsam::Pose3(gtsam::Rot3::Rz(1.0), gtsam::Point3(-0.5,-3.5,0)), noise));
  ...
  lc_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(a4, a1,
      gtsam::Pose3(gtsam::Rot3::Rz(-1.0), gtsam::Point3(-0.8,2.5,0)), noise));

  lc_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(a3, a2,
      gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(-0.9,0,0)), noise));
