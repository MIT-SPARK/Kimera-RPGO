...
/* Usage: 
  ./RpgoReadG2o {2dOrig,2dSimp} <some-2d-g2o-file> {pcm_t_simple_thresh,pcm_odo_thresh} {pcm_R_simple_thresh,pcm_lc_thresh} <gnc_barc_sq> <max_clique_method> <output-g2o-file> <verbosity> 
  [or]   
...
int main(int argc, char* argv[]) {
  ...
  if (dim == "2dOrig") {
    ...
    log<WARNING>(
        "  ./RpgoReadG2o {2dOrig,2dSimp} <some-2d-g2o-file> {pcm_t_simple_thresh,pcm_odo_thresh} {pcm_R_simple_thresh,pcm_lc_thresh} " 
        "<gnc_barc_sq> <max_clique_method> <output-g2o-file> <verbosity> ");
  }
}
